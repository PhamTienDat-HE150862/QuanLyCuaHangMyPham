                            ...
                            <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                                <div class="media d-block d-sm-flex text-center text-sm-left">
                                    ...
                                    <div class="media-body pt-3">
                                        <h3 class="product-card-title font-weight-semibold border-0 pb-0"><a href="#">${ls.name}</a>

                                        </h3>

                                        
                                        
                                        <div class="font-size-lg text-primary pt-2">${ls.price} VNĐ</div><i class="fa-solid fa-pen-line"></i>
                                        <div class="font-size-lg text-primary pt-2">Quantity: ${ls.quantity}</div><i class="fa-solid fa-pen-line"></i>
                                ...
                                <div class="pt-2 pt-sm-0 pl-sm-3 mx-auto mx-sm-0 text-center text-sm-left" style="max-width: 10rem;">
                                    ...
                                    <button onclick="window.location='editstock'"  class="btn btn-outline-editstocksecondary btn-sm btn-block mb-2" type="button" >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-update-cw mr-1">
